...
local colors = {
  ...
  overlay  = '#6c7086'
    ...
    ins_left({
      ...
      color = { fg = "#202328" }, -- Sets highlighting of component
    ...
    ins_left({
      "filename",
      path = 1, -- 0 = Only filename, 1 = Relative, 2 = Absolute
      cond = conditions.buffer_not_empty,
      color = { fg = colors.blue, gui = "bold" },
    })
    ...
    --
    --     -- Remove the current working directory prefix from the file path
